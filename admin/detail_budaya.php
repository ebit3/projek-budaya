        ...
        <div class="container mb-5">
          <form>
            ...
            <div class="form-group mt-2">
              ...
              <textarea class="ckeditor" name="jadwal" id="jadwal" readonly><?= $data['jadwal'] ?></textarea>
            </div>
            <div class="form-group mt-2">
              <label for="preview" class="mb-1">Preview</label><br>
              <textarea class="form-control" name="preview" id="preview" readonly><?= $data['preview'] ?></textarea>
            </div>
            <div class="form-group mt-2">
